...
// https://github.com/MRiscoC/Ender3V2S1 & Tjtuned
...
#define STRING_CONFIG_H_AUTHOR "Tjtuned (MRiscoC) Sprite Pro" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3V2-422-SP-BLTUBL-MPC-IS-LA"
...
#define HEATER_0_MAXTEMP 315  // 100k Hisens 3950 1% up to 300 Celcius
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 9.92 }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1561 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0629 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0740 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 112.34
  #define DEFAULT_bedKi  20.96
  #define DEFAULT_bedKd 401.43
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 4000 }  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33.5, -47.5, -1 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
